...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Dashboard/ajout client</h5>
    <a href="{{route('client')}}"><button class="btn btn-dark"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</button></a><br><br>
            @if(session()->has('status'))
                ...
                @endif
                    <form method="POST" enctype="multipart/form-data" action="{{route('save_client')}}">
                    @csrf
                    <div class="row">
                        <div class="col">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input value="{{ old('date') }}"  required  type="date" name="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input value="{{ old('ville') }}"  required  type="text" name="ville" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
